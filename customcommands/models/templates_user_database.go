...
type TemplatesUserDatabase struct {
	...
	ValueInt   int64     `boil:"value_int" json:"value_int" toml:"value_int" yaml:"value_int"`
	ValueIsInt bool      `boil:"value_is_int" json:"value_is_int" toml:"value_is_int" yaml:"value_is_int"`
...
var TemplatesUserDatabaseWhere = struct {
	...
	ValueInt   whereHelperint64
	ValueIsInt whereHelperbool
}{
	...
	ValueInt:   whereHelperint64{field: "\"templates_user_database\".\"value_int\""},
	ValueIsInt: whereHelperbool{field: "\"templates_user_database\".\"value_is_int\""},
}
...
var (
	templatesUserDatabaseAllColumns            = []string{"id", "created_at", "updated_at", "expires_at", "guild_id", "user_id", "key", "value_num", "value_raw", "value_int", "value_is_int"}
	...
	templatesUserDatabaseColumnsWithDefault    = []string{"id", "value_int", "value_is_int"}
